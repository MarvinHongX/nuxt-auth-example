...
const onLanguageChange = (value) => {
    layoutConfig.language.value = value;
};
    ...
    <Sidebar v-model:visible="visible" position="right" class="layout-config-sidebar w-26rem" pt:closeButton="ml-auto">
        <div class="p-2">
            ...
            <section class="py-4 flex align-items-center justify-content-between border-bottom-1 surface-border">
                ...
                <Dropdown :modelValue="layoutConfig.language.value" @update:modelValue="onLanguageChange" :options="languages" optionLabel="name" />
            </section>
        </div>
    </Sidebar>
</template>
